...
### 运维项目 
主要负责监控管理，zabbix的集群配置及服务部署，我在多机器部署中使用了python调用zabbix官方接口，使得快速添加机器变得更加简便。这个项目中，我最自豪的技术细节是我在本地使用docker模拟部署过一个类似集群，但因为考虑人工学习成本及安全问题没有实施。


## 文档管理项目  （ 2017年6月 ~ 2017年9月 ）
我在此项目中负责了部分后端的代码编写，有点时间较长，所有的细节多数都在博客中记录，记忆较深的是如何实现一个用户下多文件的打包下载，我采取的是python调用Linux下zip命令，打包后使用Django框架接口返回指定目录下压缩包，我最自豪的是让我整个代码水平有了提升，对项目开发有了一些理解
...
## 开源项目
 ...
 > 还有一些高start的项目我提交过不少代码，个人认为没有什么技术含量就不再这里放置，需要可以查看我的代码提交
