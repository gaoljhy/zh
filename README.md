...
### 运维项目 
主要负责监控管理，zabbix的集群配置及服务部署，在多机器部署中使用了python调用zabbix官方接口，使得快速添加机器变得更加简便。这个项目中，最自豪的技术细节是在本地使用docker编排模拟部署过一个类似集群，但因为领导考虑人工学习成本及安全问题没有实施。


## 小诺星信息科技公司  （ 2017年6月 ~ 2017年9月 ）
在此项目中负责了文档管理部分后端的代码编写，相隔时间较长，所有的细节多数都在博客中记录，整体对我个人代码以及一些架构设计水平的提升是很大的，让我的运维能力及开发水平有了显著提升，对项目开发也有了自己的一些理解和认识
